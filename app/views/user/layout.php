      ...
      <div class="col-sm-4">
        <div class="row" style="height: 100%;">
          <div class="col mt-4 text-center">
            ...
            <p class="m-1"><a class="text-dark text-decoration-none" href="index.php?page=about">About us</a></p>
          ...
          <div class="col d-flex flex-column align-items-center p-3">
            <div class="btn-block">
              <div>
                <a href="index.php?page=register" class="btn btn-outline-primary m-1 w-100">Register</a>
              </div>
              <div>
