          ...
          <div class="card shadow-sm">
            <div class="card-body">
              <div class="d-flex justify-content-between mb-3">
                <input class="form-control w-50" id="search-input" placeholder="Search questions..." type="text" />
                <div>
              ...
              <div class="table-responsive">
                <table class="table table-striped" id="questions-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>1</td>
                      <td class="description-cell" data-bs-toggle="modal" data-bs-target="#questionModal">
                      ...
                      <td>3</td>
                      <td>
                        <img alt="Placeholder image for question 1" class="img-responsive" style="max-height: 40px"
          ...
          <div class="card shadow-sm">
            ...
            <form>
                ...
                <div class="mb-3">
                    ...
                    <!-- Optionally validate this list dynamically using JavaScript -->
                </div>
...
<script>
    ...
    function attachCheckboxListeners() {
        const checkboxes = questionsTable.querySelectorAll('input[type="checkbox"]');
        ...
        newCheckbox.addEventListener("change", (event) => {
            ...
            if (!existingItem) {
                ...
                listItem.textContent = `ID: ${questionId} - ${questionDescription.substring(0, 50)}${questionDescription.length > 50 ? "..." : ""}`;
...
function previewQuizImage(event) {
    ...
    const fileNameDisplay = document.getElementById("quiz-image-filename");
